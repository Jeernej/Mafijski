...
#ax.set_title( 'Odstopanje med diferenčno in analitično rešitvijo hiperbolične valovne enačbe ( $N=100$, $dt=0.005$)')
ax.set_title( 'Časovni razvoj za hiperbolično valovno enačbo (diferenčna rešitev $N=$'+str(N)+', $dt=$'+str(N)+')')
